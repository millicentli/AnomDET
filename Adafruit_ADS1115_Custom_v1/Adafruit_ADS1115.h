...
#if ARDUINO >= 100 //Version - Lower is older version
 #include "Arduino.h" //Beta IDEs
#else
 #include "WProgram.h" //Non-Beta IDEs
#endif
...
typedef enum //prevents additional values from being added into enum
{
...
{
protected: // Instance-specific properties //The type or member can only be accessed by code in the same class or struct, or in a derived class.
